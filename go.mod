...
require (
	github.com/psanford/awsip v0.0.0-20260508085028-79ed2c63a64a
	github.com/psanford/cloudflareip v0.0.0-20240811072658-acd6b0d934b9
	github.com/psanford/gcpip v0.0.0-20260502084421-36439fe49f18
	github.com/psanford/githubip v0.0.0-20260418080451-3f40d4fd7d6b
)
